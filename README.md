...
<sub>02 · ZPE Bio animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
...
<div><b>02 · MARKETS</b><span>ADJACENT FORECASTS</span></div>
      <div>
        <div>
          <div><span>Digital cardiovascular health &rsquo;30</span><span></span><span>$141.0B</span></div>
          <div><span>Cardiac monitoring devices &rsquo;32</span><span></span><span>$31.6B</span></div>
          <div><span>Wearable ECG monitors &rsquo;30</span><span></span><span>$13.7B</span></div>
          <div><span>ECG monitoring devices &rsquo;30</span><span></span><span>$12.4B</span></div>
          <div><span>ECG data analytics &rsquo;30</span><span></span><span>$4.2B</span></div>
        </div>
      </div>
...
<div><b>05.3 · BENCHMARKS</b><span>FOUR CORPORA</span></div>
      <div>
        ...
        <div>
          <div><span>MIT-BIH</span><span></span><span>PASS</span></div>
          <div><span>NSTDB</span><span></span><span>PASS</span></div>
          <div><span>PTB-XL</span><span></span><span>out</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE PERFORMANCE</b><span>PRD BY CORPUS</span></div>
      <div>
        <div>
          <div><span>MIT-BIH · mean</span><span></span><span>1.12%</span></div>
          <div><span>NSTDB · max</span><span></span><span>1.96%</span></div>
          <div><span>EDB · max</span><span></span><span>4.34% · LOG</span></div>
          <div><span>PTB-XL · max</span><span></span><span>5.29% · OUT</span></div>
        </div>
      </div>
