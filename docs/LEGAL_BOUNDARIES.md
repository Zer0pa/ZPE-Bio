...
- Repository license: `../LICENSE` (Zer0pa Source-Available License v7.0)
- SPDX: `LicenseRef-Zer0pa-SAL-7.0`
- Python metadata and Rust crate metadata both declare the repo as `LicenseRef-Zer0pa-SAL-7.0`
